...
####################################
setwd("E:/datascientist/r-classification")
...
x <- TrainingSet$Species
y <- TrainingSet$Sepal.Length
plot(x, y, main = "Main title",
     xlab = "X axis title", ylab = "Y axis title",
     pch = 19, frame = FALSE)
# Add regression line

x1 <- TestingSet$Species
y1 <- TestingSet$Sepal.Length
plot(x1, y1, main = "Main title",
     xlab = "X axis title", ylab = "Y axis title",
     pch = 19, frame = FALSE)
abline(lm(y1 ~ x1, data = iris), col = "blue")
